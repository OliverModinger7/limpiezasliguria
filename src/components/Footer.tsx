        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white font-bold text-xl">Liguria</span>
              <span className="text-slate-500 text-sm">Limpiezas</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs mb-4">
              Servicio profesional de limpieza para hogares, oficinas y empresas. Calidad, confianza y resultados garantizados.
            </p>
