export default function Hero() {
  return (
    <section
      id="inicio"
      className="relative overflow-hidden pt-40 pb-32 min-h-screen flex flex-col bg-[#7FF5E4] bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="grid-container relative z-10 flex-1 items-start">
        <div className="col-span-12 lg:col-start-2 lg:col-span-10 mt-20">
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-[#0B1C33] leading-[1.1]">
            Confianza y calidad
            <br />
            en cada espacio.
          </h1>
